...
const advantages = [
  ...
  {
    name: "Большой опыт",
    description: "Уже более 4 лет я работаю индивидуально, и за это время получила много опыта с различными случаями. Основываясь на нем, я смогу выстроить эффективный план для быстрейшего достижения положительного результата"
  },
  {
  ...
  },
  {
    ...
    description: <span>Я постоянно <a href="#about">актуализирую</a> свои знания и использую только актуальные и научно обоснованные методики, что позволяет обеспечить наилучший результат в работе с каждым клиентом</span>
  },
  {
  ...
  {
    name: "Качество",
    description: "Я ориентирована на результат и готова погрузиться в Ваш случай, чтобы сделать речь идеальной."
  },
]
